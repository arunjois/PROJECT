...
/*
 * The JSON object will be requested from the server. 
 * After JSON object is recieved we need to parse JSON Object
 * to get melements for the DOM. Such as textbox, images, Math mode,etc.
 * 
 * 
*/
